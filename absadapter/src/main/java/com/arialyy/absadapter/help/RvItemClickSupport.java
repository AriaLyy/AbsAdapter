...
public class RvItemClickSupport {
    ...
    public static RvItemClickSupport addTo(RecyclerView recyclerView) {
        RvItemClickSupport itemClickSupport = from(recyclerView);
        if (itemClickSupport == null) {
            itemClickSupport = new RvItemClickSupport(recyclerView);
    ...
    public static void removeFrom(RecyclerView recyclerView) {
        final RvItemClickSupport itemClickSupport = from(recyclerView);
        if (itemClickSupport == null) {
            // TODO: Log warning
            return;
        }
    ...
    public static RvItemClickSupport from(RecyclerView recyclerView) {
        if (recyclerView == null) {
            return null;
        }

        return (RvItemClickSupport) recyclerView.getTag(R.id.twowayview_item_click_support);
    }
