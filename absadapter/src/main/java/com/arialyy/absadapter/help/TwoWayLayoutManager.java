...
public abstract class TwoWayLayoutManager extends LayoutManager {
    ...
    public TwoWayLayoutManager(Context context, AttributeSet attrs, int defStyle) {
        ...
        final int value = a.getInt(R.styleable.TwoWayLayoutManager_TwOrientation, 0);
    ...
    private void setupChild(View child, Direction direction) {
        final RvItemSelectionSupport itemSelection = RvItemSelectionSupport.from(mRecyclerView);
    ...
    public void onAdapterChanged(Adapter oldAdapter, Adapter newAdapter) {
        ...
        final RvItemSelectionSupport itemSelectionSupport = RvItemSelectionSupport.from(mRecyclerView);
