package com.arialyy.absadapter.help;
...
import com.arialyy.absadapter.R;

import static android.os.Build.VERSION_CODES.HONEYCOMB;

public class RvItemSelectionSupport {
    ...
    private RvItemSelectionSupport(RecyclerView recyclerView) {
    ...
    public static RvItemSelectionSupport addTo(RecyclerView recyclerView) {
        RvItemSelectionSupport itemSelectionSupport = from(recyclerView);
        if (itemSelectionSupport == null) {
            itemSelectionSupport = new RvItemSelectionSupport(recyclerView);
    ...
    public static void removeFrom(RecyclerView recyclerView) {
        final RvItemSelectionSupport itemSelection = from(recyclerView);
    ...
    public static RvItemSelectionSupport from(RecyclerView recyclerView) {
        if (recyclerView == null) {
            return null;
        }

        return (RvItemSelectionSupport) recyclerView.getTag(R.id.twowayview_item_selection_support);
    }
